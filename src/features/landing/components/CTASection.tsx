  ...
  return (
    <section className="relative py-16 md:py-28 overflow-hidden">
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 flex items-center justify-center">
        {/* Main Card */}
        <div className="rounded-3xl border border-border/40 bg-card/40 backdrop-blur-lg p-8 md:p-16 text-center space-y-8 hover:border-purple-500/50 transition-all duration-300 shadow-2xl max-w-4xl w-full">
          {/* Badge */}
